...
func adjust_reticle_lines():
	...
	var pos=Vector2.ZERO
	 # maximum speed to affect reticle
	speed = clamp(speed, 0, RETICAL_LENGTH)
	...
	top.default_color = LINE_COLOR
	right.default_color = LINE_COLOR
	bottom.default_color = LINE_COLOR
	left.default_color = LINE_COLOR
